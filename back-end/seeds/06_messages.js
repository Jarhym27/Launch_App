...
exports.seed = async function (knex) {
  ...
  await knex('messages').insert([
    ...
    },
    {
      sender_id: 2,
      recipient_id: 8,
      launch_request_id: 26,
      message: "We have a satellite looking to test manufacturing. Can you help us out?",
      notification_type: "New request",
      notification_ack: 'true',
      timestamp: '2023-03-14 16:52:12',
    },
    {
      sender_id: 8,
      recipient_id: 2,
      launch_request_id: 26,
      message: "Yes, we have you scheduled for our Falcon Heavy out of 39A",
      notification_type: "Request accepted",
      notification_ack: 'true',
      timestamp: '2023-03-16 16:52:12',
    },
    {
      sender_id: 3,
      recipient_id: 4,
    ...
    },
    {
      sender_id: 11,
      recipient_id: 10,
      launch_request_id: 28,
      message: "We will be testing a cube sate in LEO for refueling demonstrations.",
      notification_type: "New request",
      notification_ack: 'true',
      timestamp: '2023-03-15 16:52:12',
    },
    {
      ...
      recipient_id: 11,
      launch_request_id: 28,
      message: "Booked! Thanks for choosing Astra",
      notification_type: "Request accepted",
      notification_ack: 'true',
      timestamp: '2023-03-17 16:52:12',
    },
    {
      sender_id: 11,
      recipient_id: 8,
      launch_request_id: 29,
      message: "We will be testing manufacturing in space and have restrictive thermal requirements, can you support?",
      notification_type: "New request",
      notification_ack: 'true',
      timestamp: '2023-03-15 16:52:12',
    },
    {
      ...
      recipient_id: 11,
      launch_request_id: 29,
      message: "Yes, we have done many launches with specific thermal requirements. We look forward to working with you.",
      notification_type: "Request accepted",
      notification_ack: 'true',
      timestamp: '2023-03-17 16:52:12',
    },
